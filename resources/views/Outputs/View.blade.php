                ...
                <tbody>
                    ...
                    @foreach ($outputs as $output)
                        <tr>
                            ...
                            <td class="text-center">{{ $output['number'] }}</td>
                            <td class="text-center">{{ $output['subaccount_id'] }}</td>
                            <td class="text-center">{{ $output['department_id'] }}</td>
                            <td class="text-center">{{ $output['employee_id'] }}</td>
                            <td class="text-center">{{ $output['user_id'] }}</td>
                            <td class="text-center">
                                <!-- boton trigger modal para ver detalles de productos -->
                                <button class="btn btn-warning details-btn" data-bs-toggle="modal" data-bs-target="#details-entries" data-id="{{ $output['id'] }}">
                                ...
                                <button type="button" class="btn btn-warning update_btn" data-bs-toggle="modal" data-bs-target="#update_entries" data-id="{{ $output['id'] }}">
                                ...
                                <button class="btn btn-danger btn-delete" data-id="{{ $output['id'] }}">
