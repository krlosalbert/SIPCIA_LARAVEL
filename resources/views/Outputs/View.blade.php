...
@section('content')
    <div class="card d-flex justify-content-around flex-wrap" id="base">
        <div class="table-responsive">
            ...
            <table class="table" id="outputs">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th class="text-center" scope="col">Numero de Salida</th>
                ...
                <tbody>
                    ...
                    @foreach ($outputs as $output)
                        <tr>
                            ...
                            <td class="text-center">{{ $output['output_number'] }}</td>
                            <td class="text-center">{{ $output['subaccount_name'] }}</td>
                            <td class="text-center">{{ $output['department_name'] }}</td>
                            <td class="text-center">{{ $output['employee_name'] }}</td>
                            <td class="text-center">{{ $output['user_name'] }} {{ $output['user_lastname'] }}</td>
                            <td class="text-center">
                                <!-- boton trigger modal para ver detalles de productos -->
                                <button class="btn btn-warning details-btn" data-bs-toggle="modal" data-bs-target="#details-entries" data-id="{{ $output['output_id'] }}">
                                ...
                                <button type="button" class="btn btn-warning update_btn" data-bs-toggle="modal" data-bs-target="#update_entries" data-id="{{ $output['output_id'] }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                        <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                                    </svg>
                                </button>

                                <!-- formulario para eliminar una entrada -->
                                <button class="btn btn-danger btn-delete" data-id="{{ $output['output_id'] }}">
            ...
            <div class="modal fade" id="update_entries" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog  modal-md text-left">
                    <div class="modal-content d-flex justify-content-left align-items-left">
                        <div class="modal-header w-100">
                            <h5 class="modal-title" id="exampleModalLabel"><b>Editar entradas</b></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body w-100" id="body">
            ...
            @section('js')
                ...
                @if(session('success'))
                    <script>
                        swal("Listo!", "Salida Actualizada con Exito!", "success")
                            .then((value) => {
                        }) 
                    </script>
                @endif
