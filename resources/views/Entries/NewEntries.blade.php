                    ...
                    <div class="card-body">
                        <div class="d-flex w-auto">
                            <div class="d-inline w-100 ">
                                <label for="search"><b>Buscar producto:</b></label>
                        ...
                        <form action="{{ route('create_entries') }}" method="POST">
                            ...
                            <div class="d-flex w-auto">
                                <div class="d-inline w-100 p-2">
                                    ...
                                    <input type="date" class="form-control" id="date" name="date" placeholder="Ingrese la fecha de la factura" value="{{ old('date') }}">
                                </div>
                            </div>
                            <div class="d-flex w-auto">
                                <div class="d-inline w-100 p-2">
